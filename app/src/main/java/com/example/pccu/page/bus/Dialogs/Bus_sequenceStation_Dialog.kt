...
class Bus_sequenceStation_Dialog(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        saveStation = getArguments()!!.getSerializable("CollectStation") as CollectGroup  //拆包裹
        ...
        buttonOk.setOnClickListener {
            CollectList!!.forEach {
                if (it.GroupName == saveStation!!.GroupName) {
            ...
            GlobalScope.launch(Dispatchers.Main) {
                ...
                val toast: Toast =
                    Toast.makeText(parentFragment!!.context!!, "排序站牌成功", Toast.LENGTH_SHORT)
    ...
    inner class Adapter : RecyclerView.Adapter<MyViewHolder>(), IItemTouchHelperAdapter  {
        ...
        override fun onItemMove(fromPosition: Int, toPosition: Int) {
            if(!sequenced)
                sequenced = true
            Collections.swap(saveStation!!.SaveStationList, fromPosition, toPosition)
    ...
    inner class MyViewHolder : RecyclerView.ViewHolder,IItemTouchHelperViewHolder {
        ...
        private var bus_dialog_station_sequence_item: LinearLayout? = null

        constructor(itemView: View) : super(itemView) {
            bus_dialog_station_sequence_item = itemView.bus_dialog_station_sequence_item
        }

        override fun onItemSelected() {
            bus_dialog_station_sequence_item!!.setBackgroundColor(
